...
\author{\unsername}
%\date{\today}
\date{10.  Mai 2023} % Versammlungsdatum
...
\item Wahlen können en block (Blockwahl) erfolgen. Dabei werden für verschiedene 
zu wählende Ämter, pro Amt jeweils genau ein*e Kandidat*in vorgeschlagen. Die Annahme (Wahl) 
erfolgt für alle vorgeschlagenen Kandidat*innen gleichzeitig mit einer Abstimmung. 
Jede*r Stimmberechtigte hat in dieser Abstimmung eine Stimme.
